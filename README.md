...
предупреждения, режим, агенты с разбивкой по моделям, минуты, токены или подсказка ввести `/cost`,
источник правил, подавленное skip-list) — её переносят в описание PR.
